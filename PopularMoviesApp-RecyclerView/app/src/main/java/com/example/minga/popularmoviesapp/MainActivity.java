...
import com.example.minga.popularmoviesapp.adapter.MoviesAdapter;
...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // RecyclerView Setup
        rvMovies = (RecyclerView) findViewById (id.movies_rv);
        rvMovies.setLayoutManager (new StaggeredGridLayoutManager (2, StaggeredGridLayoutManager.VERTICAL));
        movies = new ArrayList<Movie> ();
        rvMoviesAdapter = new MoviesAdapter (getApplicationContext (),movies);
        rvMovies.setAdapter (rvMoviesAdapter);
        ...
        rvMovies.addItemDecoration(itemDecoration2);
    ...
    public class JsonLoadTask extends AsyncTask<URL, Void, Void> {
        ...
        protected void onPostExecute(Void result){
            ...
            if (movies != null ){
                rvMoviesAdapter.updateRvAdapter (movies);
    ...
    public void populateUiFavoriteMovie(){
        ...
        favoriteMovies.observe (this, new Observer<List<Movie>> () {
            ...
            public void onChanged(@Nullable List<Movie> movies) {
                ...
                if (apiType.equals ("3")){
                    rvMoviesAdapter.updateRvAdapter (( ArrayList<Movie> ) movies);
